...
<head>
    ...
    <title>{{ config('app.name') }} | Empoyee</title>
    ...
    <link rel="stylesheet" href="{{ asset('/bower_components/plugins/toastr/toastr.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/bower_components/plugins/summernote/summernote-bs4.css') }}">
...
<script src="{{ asset('bower_componentsz/plugins/toastr/toastr.min.js') }}"></script>
<script src="{{ asset('/bower_components/plugins/summernote/summernote-bs4.min.js') }}"></script>
